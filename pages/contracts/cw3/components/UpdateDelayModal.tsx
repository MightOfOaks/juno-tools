  ...
  const updateMinDelay = async () => {
    try {
      ...
      if (!(isNaN(minDelay) || Number(minDelay) < 1)) {
        ...
        toast.success('Successfully updated the minimum delay.', {style: { maxWidth: 'none' } })
    ...
    <div className="bg-dark-gray p-8">
      ...
      <div className='flex'>
        ...
        <div className="px-1 mt-10 basis-3/4">
          {spinnerFlag && (
          <svg role="status" className="mr-2 w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-juno" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
