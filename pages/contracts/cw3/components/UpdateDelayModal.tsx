  ...
  return (
    <div className="bg-dark-gray p-8">
      ...
      <div className="flex-col basis-1/4 my-4">
        ...
        <label
          htmlFor="small-input"
          className="mb-1 ml-3 mr-2 block text-md font-bold text-gray-900 dark:text-gray-300"
        >
          Minimum Delay
        </label>
        <Tooltip label="The minimum timelock duration for future operations.">
          <svg className="mt-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>        
        </Tooltip>
        </div>
      ...
      <div className="flex">
        <div className="pl-2 mt-8 basis-3/4">
          <button
        ...
        <div className="px-1 mt-10 basis-3/4">
          {spinnerFlag && (
            <svg
              role="status"
